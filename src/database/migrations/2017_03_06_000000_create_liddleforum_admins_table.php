...
class CreateLiddleForumAdminsTable extends Migration
{
    /**
    ...
    public function up()
    {
        Schema::create(config('liddleforum.database_prefix') . 'admins', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop(config('liddleforum.database_prefix') . 'admins');
    }
}
